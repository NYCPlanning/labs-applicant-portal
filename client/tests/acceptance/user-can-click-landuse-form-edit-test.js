...
import {
  visit, click, currentURL, fillIn, triggerKeyEvent,
...
module('Acceptance | user can click landuse form edit', function (hooks) {
  ...
  test('User can edit, save and submit landuse form', async function (assert) {
    ...
    await click(
      '[data-test-radio="dcpApplicantispublicagencyactions"][data-test-action="ZC"][data-test-radio-option="Yes"]',
    );
    await click(
      '[data-test-radio="dcpApplicantispublicagencyactions"][data-test-action="ZA"][data-test-radio-option="No"]',
    );
    await click(
      '[data-test-radio="dcpApplicantispublicagencyactions"][data-test-action="MM"][data-test-radio-option="Yes"]',
    );
  ...
  test('User can edit Site Information on the landuse form', async function (assert) {
    ...
    await fillIn(
      '[data-test-input="dcpSitedatacommunitydistrict"]',
      'Some value',
    );
    await fillIn(
      '[data-test-input="dcpSitedatazoningsectionnumbers"]',
      'Some value',
    );
    await fillIn(
      '[data-test-input="dcpSitedataexistingzoningdistrict"]',
      'Some value',
    );
    ...
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpSitedataadress,
      'Some value',
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpCitycouncil,
      'Some value',
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpSitedatacommunitydistrict,
      'Some value',
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpSitedatazoningsectionnumbers,
      'Some value',
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpSitedataexistingzoningdistrict,
      'Some value',
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpSpecialdistricts,
      'Some value',
    );
  ...
  test('User can reveal Project Area conditional questions', async function (assert) {
    ...
    await click(
      '[data-test-radio="dcpWholecity"][data-test-radio-option="Yes"]',
    );

    assert.dom('[data-test-radio="dcpEntiretyboroughs"]').doesNotExist();

    await click(
      '[data-test-radio="dcpWholecity"][data-test-radio-option="No"]',
    );
    ...
    await click(
      '[data-test-radio="dcpEntiretyboroughs"][data-test-radio-option="Yes"]',
    );
    ...
    await click(
      '[data-test-radio="dcpEntiretyboroughs"][data-test-radio-option="No"]',
    );
    ...
    await click(
      '[data-test-radio="dcpEntiretycommunity"][data-test-radio-option="Yes"]',
    );
    ...
    await click(
      '[data-test-radio="dcpEntiretycommunity"][data-test-radio-option="No"]',
    );
    ...
    await click(
      '[data-test-radio="dcpNotaxblock"][data-test-radio-option="Yes"]',
    );
    ...
    await click(
      '[data-test-radio="dcpNotaxblock"][data-test-radio-option="No"]',
    );
    ...
    await click(
      '[data-test-radio="dcpHistoricdistrict"][data-test-radio-option="Yes"]',
    );

    assert.dom('[data-test-input="dcpSitedatarenewalarea"]').exists();

    await fillIn(
      '[data-test-input="dcpSitedatarenewalarea"]',
      exceedMaximum(100, 'String'),
    );
    assert
      .dom('[data-test-validation-message="dcpSitedatarenewalarea"]')
  ...
  test('User resets values of all radio descendants when changing radio answers in Project Area', async function (assert) {
    ...
    await fillIn(
      '[data-test-input="dcpSitedatapropertydescription"]',
      'Planning',
    );

    await assert
      .dom('[data-test-input="dcpSitedatapropertydescription"]')
      .hasValue('Planning');
  ...
  test('User is required to fill out Proposed Development Site conditional fields', async function (assert) {
    ...
    await click(
      '[data-test-radio="dcp500kpluszone"][data-test-radio-option="No"]',
    );

    assert.dom('[data-test-validation-message="dcpDevsize"]').doesNotExist();

    await click(
      '[data-test-radio="dcp500kpluszone"][data-test-radio-option="Yes"]',
    );

    assert.dom('[data-test-submit-button]').hasAttribute('disabled');
    assert
      .dom('[data-test-validation-message="dcpDevsize"]')
      .containsText('required');

    await click(
      '[data-test-radio="dcpDevsize"][data-test-radio-option="500,000 to 999,999 zoning sq ft"]',
    );

    assert.dom('[data-test-validation-message="dcpDevsize"]').doesNotExist();

    await click(
      '[data-test-radio="dcpSitedatasiteisinnewyorkcity"][data-test-radio-option="No"]',
    );

    assert
      .dom('[data-test-validation-message="dcpSitedataidentifylandmark"]')
      .doesNotExist();

    await click(
      '[data-test-radio="dcpSitedatasiteisinnewyorkcity"][data-test-radio-option="Yes"]',
    );
    ...
    await fillIn(
      '[data-test-input="dcpSitedataidentifylandmark"]',
      'Douglas Fir',
    );
  ...
  test('User can add and a related action on the landuse form', async function (assert) {
    ...
    await click(
      '[data-test-radio="dcpIscompletedaction"][data-test-radio-option="Yes"]',
    );
    await fillIn('[data-test-input="dcpReferenceapplicationno"]', '12345678');
    await fillIn(
      '[data-test-input="dcpApplicationdescription"]',
      'applicant description',
    );
    await fillIn(
      '[data-test-input="dcpDispositionorstatus"]',
      'disposition or status',
    );
    await fillIn(
      '[data-test-input="dcpCalendarnumbercalendarnumber"]',
      'calendar number',
    );
    ...
    assert.equal(this.server.db.applicants.firstObject.dcpFirstname, 'Tess');
    assert.equal(
      this.server.db.relatedActions.firstObject.dcpReferenceapplicationno,
      '12345678',
    );
    assert.ok(
      this.server.db.relatedActions.firstObject.dcpApplicationdate[0].includes(
        '2020-01-01',
      ),
    );
  });
  ...
  test('User can fill out and save Housing Plans section', async function (assert) {
    ...
    await click(
      '[data-test-radio="dcpDesignation"][data-test-radio-option="No (HC, HD, HO, HP, possibly HU)"]',
    );
    await click(
      '[data-test-radio="dcpDesignation"][data-test-radio-option="Yes (HA, HN, HG, possibly HU)"]',
    );

    await click(
      '[data-test-radio="dcpProjecthousingplanudaap"][data-test-radio-option="No (HC, HD, HO, HP, HU)"]',
    );
    await click(
      '[data-test-radio="dcpProjecthousingplanudaap"][data-test-radio-option="Yes (HA, HN, HG)"]',
    );

    await click(
      '[data-test-radio="dcpDisposition"][data-test-radio-option="No (HC, HD, HG, HN, HO, HP, HU)"]',
    );
    ...
    await click(
      '[data-test-radio="dcpDisposition"][data-test-radio-option="Yes (HA, HD)"]',
    );
    ...
    await click(
      '[data-test-radio="dcpMannerofdisposition"][data-test-radio-option="Direct"]',
    );
    ...
    await click(
      '[data-test-radio="dcpMannerofdisposition"][data-test-radio-option="General"]',
    );
    await click(
      '[data-test-radio="dcpMannerofdisposition"][data-test-radio-option="Direct"]',
    );
  ...
  test('user can remove related actions on landuse form', async function (assert) {
    ...
    const serverSideRelatedAction = this.server.create('related-action', {
      landuseForm,
    });
    // get the reference to the model instance
    await this.owner
      .lookup('service:store')
      .findRecord('related-action', serverSideRelatedAction.id);
  ...
  test('User can update the primary contact information on the landuse form', async function (assert) {
    ...
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpContactname,
      'contact name',
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpContactphone,
      '1112223333',
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpContactemail,
      'contact@email.com',
    );
  ...
  test('User can update the project name on the landuse form', async function (assert) {
    ...
    await fillIn(
      '[data-test-input="dcpSitedataprojectname"]',
      'new site data project name',
    );

    await click('[data-test-save-button]');

    assert.equal(
      this.server.db.landuseForms.firstObject.dcpSitedataprojectname,
      'new site data project name',
    );
  ...
  test('User can update the environmental review information on the landuse form', async function (assert) {
    ...
    await click(
      '[data-test-radio="dcpCeqrtype"][data-test-radio-option="Type II"]',
    );
    ...
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpCeqrnumber,
      '12345',
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpCeqrtype,
      717170001,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpTypecategory,
      'type category',
    );
  ...
  test('User only sees last questions under Project Area, Proposed Development Site, Project Tax Lots when project applies to partial area', async function (assert) {
    ...
    assert.dom('[data-test-input="dcpSitedatarenewalarea"]').doesNotExist();
    assert
      .dom('[data-test-section="proposed-development-site"]')
      .doesNotExist();
  ...
  test('User can update proposed actions section', async function (assert) {
    ...
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpOwnersubjectproperty,
      true,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpLeesseesubjectproperty,
      true,
    );
    assert.equal(this.server.db.landuseForms.firstObject.dcpIsother, undefined);
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpLeaseorbuy,
      undefined,
    );

    // filling out the proposed actions section
    await click(
      '[data-test-radio="dcpLegalinstrument"][data-test-radio-option="Yes"]',
    );
    await selectChoose(
      '[data-test-dcpPreviouslyapprovedactioncode-picker="ZC"]',
      'BF',
    );
    await selectChoose(
      '[data-test-dcpPreviouslyapprovedactioncode-picker="ZA"]',
      'LD',
    );
    await click(
      '[data-test-radio="dcpApplicantispublicagencyactions"][data-test-action="ZC"][data-test-radio-option="Yes"]',
    ...
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpLegalinstrument,
      717170000,
    );
    assert.equal(
      this.server.db.landuseActions[0].dcpPreviouslyapprovedactioncode,
      717170016,
    );
    assert.equal(
      this.server.db.landuseActions[1].dcpPreviouslyapprovedactioncode,
      717170013,
    );
    assert.equal(
      this.server.db.landuseActions[0].dcpApplicantispublicagencyactions,
      true,
    );
    assert.equal(
      this.server.db.landuseActions[1].dcpApplicantispublicagencyactions,
      false,
    );
    ...
    assert.ok(
      this.server.db.landuseActions.firstObject.dcpRecordationdate[0].includes(
        '2020-01-01',
      ),
    );
  ...
  test('User can add, fill out, save and remove Subject Sites subsections', async function (assert) {
    ...
    await click(
      '[data-test-radio="dcpSitetobedisposed"][data-test-radio-option="Yes"]',
    );
    await click(
      '[data-test-radio="dcpSitetobedisposed"][data-test-radio-option="No"]',
    );
    await fillIn('[data-test-input="dcpProposeduses"]', '12345');

    await fillIn(
      '[data-test-input="dcpLotnumberstring"]',
      exceedMaximum(250, 'String'),
    );
    assert
      .dom('[data-test-validation-message="dcpLotnumberstring"]')
      .hasText('Number is too long (max 250 characters)');
  ...
  test('User can fill out Public Facilities section', async function (assert) {
    ...
    await click(
      '[data-test-radio="dcpIndicatetypeoffacility"][data-test-radio-option="Local/Neighborhood"]',
    );

    assert
      .dom('[data-test-input="dcpHowlonghasexistingfacilitybeenatthislocat"]')
      .doesNotExist();
    assert
      .dom('[data-test-radio="dcpExistingfacilityreplacementinanewlocation"]')
      .exists();

    await click(
      '[data-test-radio="dcpExistingfacilityproposedtoremainopt"][data-test-radio-option="Yes"]',
    );
    ...
    await fillIn(
      '[data-test-input="dcpHowlonghasexistingfacilitybeenatthislocat"]',
      'A while.',
    );

    await click(
      '[data-test-radio="dcpExistingfacilityproposedtoremainopt"][data-test-radio-option="No"]',
    );
    ...
    await click(
      '[data-test-radio="dcpExistingfacilityreplacementinanewlocation"][data-test-radio-option="Yes"]',
    );

    assert.dom('[data-test-input="dcpTextexistingfacility"]').doesNotExist();
    await fillIn(
      '[data-test-input="dcpCurrentfacilitylocation"]',
      'Vibrant streets',
    );

    await click(
      '[data-test-radio="dcpExistingfacilityproposedtoremainandexpand"][data-test-radio-option="Yes"]',
    );

    await fillIn(
      '[data-test-input="dcpTextexistingfacility"]',
      'More than a while.',
    );

    await click(
      '[data-test-radio="dcpNewfacilityopt"][data-test-radio-option="Yes"]',
    );
    await click(
      '[data-test-radio="dcpIsprojectlistedinstatementofneedsopt"][data-test-radio-option="Yes"]',
    );

    await fillIn('[data-test-input="dcpIndicatefiscalyears"]', '1997 - 2020');
    await fillIn('[data-test-input="dcpIndicatepgno"]', 'Page 19');
    await click(
      '[data-test-radio="dcpDidboroughpresidentproposealternativesite"][data-test-radio-option="No"]',
    );
  ...
  test('Nested (i.e. Cascading, descendant) questions in Public Facilities reset when parent question values change', async function (assert) {
    ...
    assert
      .dom(
        '[data-test-radio="dcpExistingfacilityreplacementinanewlocation"][data-test-radio-option="No"]',
      )
    ...
    assert
      .dom('[data-test-input="dcpCurrentfacilitylocation"]')
      .hasValue('A hip warehouse.');
    ...
    assert
      .dom('[data-test-input="dcpTextexistingfacility"]')
      .hasValue('Many decades.');

    await click(
      '[data-test-radio="dcpExistingfacilityproposedtoremainandexpand"][data-test-radio-option="No"]',
    );
    await click(
      '[data-test-radio="dcpExistingfacilityproposedtoremainandexpand"][data-test-radio-option="Yes"]',
    );
    ...
    assert
      .dom('[data-test-input="dcpIndicatefiscalyears"]')
      .hasValue('Many decades.');

    await click(
      '[data-test-radio="dcpIsprojectlistedinstatementofneedsopt"][data-test-radio-option="No"]',
    );
    await click(
      '[data-test-radio="dcpIsprojectlistedinstatementofneedsopt"][data-test-radio-option="Yes"]',
    );
  ...
  test('User can update Change in City Map section', async function (assert) {
    ...
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpEstablishstreetopt,
      true,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpEstablishparkopt,
      undefined,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpEstablishpublicplaceopt,
      undefined,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpEstablishgradeopt,
      undefined,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpEstablisheasement,
      true,
    );
    ...
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpEliminatestreetopt,
      true,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpEliminateparkopt,
      undefined,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpEliminatepublicplaceopt,
      undefined,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpEliminategradeopt,
      undefined,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpEliminateeasement,
      true,
    );
    ...
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpChangestreetwidthopt,
      true,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpChangestreetalignmentopt,
      undefined,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpChangestreetgradeopt,
      undefined,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpChangeeasement,
      true,
    );

    await click(
      '[data-test-radio="dcpRelatedacquisitionofpropertyopt"][data-test-radio-option="Yes"]',
    );
    await click('[data-test-related-acquisition="true"]');
    await click(
      '[data-test-radio="dcpOnlychangetheeliminationofamappedbutunimp"][data-test-radio-option="No"]',
    );

    await click('[data-test-save-button]');

    assert.equal(
      this.server.db.landuseForms.firstObject
        .dcpRelatedacquisitionofpropertyopt,
      1,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpRelatedacquisition,
      true,
    );
    assert.equal(
      this.server.db.landuseForms.firstObject
  ...
  test('User can add, fill out, save and remove Proposed Site Characteristics subsection', async function (assert) {
    ...
    // integer fields
    await fillIn(
      '[data-test-input="dcpCommunityfacilitycommercialnooffirms"]',
      123,
    );
    await fillIn('[data-test-input="dcpNumberofdwellingunits"]', 123);
    await fillIn(
      '[data-test-input="dcpBuildingsorsitetotalsquarefootage"]',
      123,
    );
    await fillIn('[data-test-input="dcpSquarefootagetobeacquired"]', 123);
    await fillIn(
      '[data-test-input="dcpCommunityfacilitycommercialnoofemployees"]',
      123,
    );

    await click(
      '[data-test-radio="dcpIsthesiteimprovedunimprovedorpartlyimp"][data-test-radio-option="Unimproved"]',
    );
    ...
    await fillIn(
      '[data-test-input="dcpDisplacementorrelocation"]',
      'text text',
    );
    await fillIn('[data-test-input="dcpLot"]', 'text text');
    await fillIn('[data-test-input="dcpBlock"]', 'text text');
    await fillIn(
      '[data-test-input="dcpNumberoffloorsinbuilding"]',
      'text text',
    );
    await fillIn(
      '[data-test-input="dcpVacantforlessthantwoyears"]',
      'text text',
    );
  ...
  test('User can fill out Disposition section', async function (assert) {
    ...
    await click(
      '[data-test-radio="dcpTypedisposition"][data-test-radio-option="General"]',
    );
    ...
    await click(
      '[data-test-radio="dcpTypedisposition"][data-test-radio-option="Direct"]',
    );
    ...
    assert
      .dom('[data-test-disposition-dcpRestrictandcondition-helptext]')
      .doesNotExist();

    await click(
      '[data-test-radio="dcpRestrictandcondition"][data-test-radio-option="None (Pursuant to Zoning)"]',
    );
    ...
    await click(
      '[data-test-radio="dcpRestrictandcondition"][data-test-radio-option="Restricted"]',
    );
  ...
  test('User can add and delete a ZR Section on the landuse form', async function (assert) {
    ...
    await fillIn(
      '[data-test-input="dcpZrsectionnumber"]',
      'our zr section number',
    );
    await fillIn(
      '[data-test-input="dcpZrsectiontitle"]',
      'our zr section title',
    );
    await click('[data-test-save-button]');

    assert.equal(
      this.server.db.affectedZoningResolutions.firstObject.dcpZrsectionnumber,
      'our zr section number',
    );
    assert.equal(
      this.server.db.affectedZoningResolutions.firstObject.dcpZrsectiontitle,
      'our zr section title',
    );
  ...
  test('User can add and delete a Zoning Map Change on the landuse form', async function (assert) {
    ...
    await selectChoose(
      '[data-test-dcpTotalzoningareatoberezoned-dropdown]',
    ...
    await fillIn(
      '[data-test-input="dcpZoningsectionmapsnumber"]',
      exceedMaximum(100, 'String'),
    );
    assert
      .dom('[data-test-validation-message="dcpZoningsectionmapsnumber"]')
      .exists();

    await fillIn(
      '[data-test-input="dcpZoningsectionmapsnumber"]',
      'zoning section num 1234',
    );
    assert
      .dom('[data-test-validation-message="dcpZoningsectionmapsnumber"]')
      .doesNotExist();
    ...
    await fillIn(
      '[data-test-input="dcpExistingzoningdistrictvaluenew"]',
      exceedMaximum(30, 'String'),
    );
    assert
      .dom('[data-test-validation-message="dcpExistingzoningdistrictvaluenew"]')
      .exists();
    ...
    await fillIn(
      '[data-test-input="dcpProposedzoningmapvalue"]',
      exceedMaximum(100, 'String'),
    );
    assert
      .dom('[data-test-validation-message="dcpProposedzoningmapvalue"]')
      .exists();

    await fillIn(
      '[data-test-input="dcpProposedzoningmapvalue"]',
      'some zoning map value',
    );
    assert
      .dom('[data-test-validation-message="dcpProposedzoningmapvalue"]')
      .doesNotExist();
    ...
    assert.equal(
      this.server.db.landuseForms.firstObject.dcpTotalzoningareatoberezoned,
      717170006,
    );
    assert.equal(
      this.server.db.zoningMapChanges.firstObject.dcpZoningsectionmapsnumber,
      'zoning section num 1234',
    );
    assert.equal(
      this.server.db.zoningMapChanges.firstObject
        .dcpExistingzoningdistrictvaluenew,
      'zoning district R2A',
    );
    assert.equal(
      this.server.db.zoningMapChanges.firstObject.dcpProposedzoningmapvalue,
      'some zoning map value',
    );
  ...
  test('User can search and select from zoning resolution dropdown in proposed actions section', async function (assert) {
    ...
    await selectChoose(
      '[data-test-zoning-resolution-picker="ZA"]',
      'AppendixF',
    );
