...
export const actions = [
  ...
  [
    ...
    '(Non-ULURP) Proposed New York City Landmarks and Historic Districts are submitted to the Department of City Planning by the Landmarks Preservation Commission to ensure that the landmark designation does not conflict with the Zoning Resolution, projected public improvements or any plans for development, growth, improvement, or renewal in the vicinity of the landmark. Landmark designations are non-ULURP actions.',
  ],
  ['HL', 'Housing/Urban Renewal/Pub Ben Corp Lease', ''],
  ['HM', 'Currently Residential/Not Low-Income', ''],
  [
    'HN',
    'Urban Development Action Area - UDAAP Non-ULURP',
    'A project may qualify for the Urban Development Action Area Program (UDAAP) exemption if it involves rehabilitating housing or building new housing on land that used to be owned by the City and has been designated by the City Council as an area in need of urban renewal.',
  ],
  ...
  [
    'LD',
    'Legal Document (NOC, NOR, RD)',
    'An LD action indicates that a project has one or more additional actions related to associated legal documents (such as a "Restrictive Declaration" RD, "Notice of Restriction" NOR, or "Notices of Certification" NOC) that impose additional property controls beyond zoning regulations. Such additional actions could be, for example, that a legal document is being created or modified, or that there is a follow-up approval pursuant to an existing legal document being processed.',
  ],
  ['MA', 'Assignment/Acquisition', ''],
  [
    'MC',
    'Major Concessions',
    '(ULURP) A major concession is a grant made by an agency for the private use of city-owned property, and which has significant land use impacts and implications or which requires the preparation of an environmental impact statement. The City Planning Commission has established rules for determining if a concession is major and requires ULURP review.',
  ],
  ['MD', 'Drainage Plan', ''],
  [
    'ME',
    'Easements (Administrative)',
    '(Non-ULURP) An easement allows for an entity or individual to have limited use of another’s property for a specific purpose. Please contact the Department’s Technical Review Division to discuss new easements or modifications to existing easements and the associated application requirements.',
  ],
  ['MF', 'Franchise Applic - Not Sidewalk Café', ''],
  [
    'ML',
    'Landfill',
    '(ULURP) Landfill applications are applications for the establishment of sanitary or waterfront landfills.',
  ],
  [
    'MM',
    'Change in City Map',
    '(ULURP) The City Map is the official adopted map of the city. It shows the location, dimension and grades of streets, parks, public places, and certain public easements. The Director of City Planning is the custodian of the City Map. City Map changes are applications to alter, add, or remove elements from the City Map.',
  ],
  ['MP', 'Prior Action', ''],
  ...
  [
    ...
    '(ULURP) Dispositions of non-residential city-owned property are used to release property acquired by the city for use or development by another party.  This includes the sale, lease, or exchange of real property. This action is subject to the Uniform Land Use Review Procedure.',
  ],
  [
    'PQ',
    'Acquisition of Property by the City',
    '(ULURP) Acquisition of real property by the city occurs when the city endeavors to acquire real property for the purposes of community or city use.  Office space acquisition is excluded and subject to a separate review pursuant to Section 195 of the City Charter. This action is subject to the Uniform Land Use Review Procedure.',
  ],
  ['PR', "Release of City's Interest", ''],
  [
    'PS',
    'Site Selection (City Facility) ',
    '(ULURP) Site selection for capital projects includes the selection of sites for new city facilities such as sanitation garages, fire houses, libraries and sewage treatment plants. A capital project is the construction or acquisition of a public improvement classified as a capital asset of the city. This action is subject to the Uniform Land Use Review Procedure.',
  ],
  [
    'PX',
    'Office Space',
    '(Non-ULURP) Applications for the leasing of office space by city agencies are typically filed by the Department of Citywide Administrative Services. Office space lease actions are non-ULURP and are required to move through the approval process on a specific timeline.',
  ],
  [
    'RA',
    'South Richmond District Authorizations ',
    '(Non-ULURP) A Zoning Authorization within the Special South Richmond Development District (SSRDD) is a discretionary action taken by the City Planning Commission (CPC) that modifies specific zoning requirements if certain findings have been met. Authorizations are not subject to ULURP review and the CPC does not hold public hearings on authorizations. The CPC generally refers such applications to the appropriate community board(s) for comments.',
  ],
  [
    'RC',
    'South Richmond District Certifications',
    '(Non-ULURP) A Special South Richmond Development District certification is a non-discretionary action taken by the City Planning Commission, or its Chairperson, informing the Department of Buildings that an as-of-right development has complied with specific conditions set forth in accordance with provisions of the Zoning Resolution.',
  ],
  [
    'RS',
    'South Richmond District Special Permits',
    '(ULURP) Special permits within the Special South Richmond Development District (SSRDD) are discretionary approvals that can modify zoning controls within the Special District, such as use, bulk, and parking. Special Permits are reviewed by the City Planning Commission pursuant to the Zoning Resolution and are subject to the Uniform Land Use Review Procedure.',
  ],
  [
    'SC',
    'Special Natural Area Certifications',
    'The purpose of the Special Natural Area District (NA) is to guide new development and site alterations in areas endowed with unique natural characteristics, including forests, rock outcrops, steep slopes, creeks and a variety of botanic and aquatic environments.',
  ],
  ['TC', 'Consent - Sidewalk Café', ''],
  [
    'TL',
    'Leasing of C-O-P By Private Applicants',
    'Leasing of City-Owned Properties by Private Applicants.',
  ],
  ['UC', 'Unenclosed Café', ''],
  ['VT', 'Cable TV', ''],
  [
    ...
    '(Non-ULURP) An authorization is a discretionary action taken by the City Planning Commission (CPC) that modifies specific zoning requirements if certain findings have been met. Authorizations are not subject to ULURP review, and the CPC does not hold public hearings on authorizations. The CPC generally refers such applications to the appropriate community board(s) for comment.',
  ],
  [
    'ZC',
    'Zoning Certification',
    '(Non-ULURP) Each Zoning Certification is a distinct land use action and requires specific land use application components.',
  ],
  ...
  [
    ...
    '(ULURP) A Zoning Map Amendment is a change in designation or a change in district boundaries for any zoning district on the New York City Zoning Map.  Zoning Map Amendments are discretionary actions subject to the Uniform Land Use Review Procedure.',
  ],
  [
    'ZP',
    'Parking Special Permit/Incl non-ULURP Ext',
    'A special permit was a discretionary action by the City Planning Commission (CPC), subject to ULURP review, or the Board of Standards and Appeals (BSA), which may modify use, bulk or parking regulations if certain condi­tions and findings specified in the Zoning Resolution are met.',
  ],
  [
    'ZR',
    'Zoning Text Amendment',
    '(non-ULURP) Zoning Text Amendments are changes to the text of the New York City Zoning Resolution.  Text Amendments do not require the Uniform Land Use Review Procedure, however, in practice; the Department of City Planning refers Zoning Text Amendments to the Community Board for review.',
  ],
  [
    'ZS',
    'Zoning Special Permit',
    '(ULURP) A special permit is a discretionary action by the City Planning Commission, subject to ULURP review, or the Board of Standards and Appeals, which may modify use, bulk, or parking regulations if certain conditions and findings specific in the Zoning Resolution are met.',
  ],
  ['ZX', "Counsel's Office - Rules of Procedure", ''],
  [
    'ZZ',
    'Site Plan Approval in Natural Area Districts',
    'The purpose of the Special Natural Area District (NA) was to guide new development and site alterations in areas endowed with unique natural characteristics, including forests, rock outcrops, steep slopes, creeks and a variety of botanic and aquatic environments.',
  ],
].map(([code, short, tooltip]) => ({
  code,
  short,
  tooltip,
  searchField: `${code} ${short}`,
}));
