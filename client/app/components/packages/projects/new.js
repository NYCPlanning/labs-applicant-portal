...
export default class ProjectsNewFormComponent extends Component {
  ...
  async submitPackage() {
    try {
      ...
      // const contact = await this.store.queryRecord("contact", {
      //   email: this.args.package.contactEmail,
      // });
      // console.debug('project name', this.args.package.projectName)
      // console.debug("contact result", contact);
      // const projectApplicant = await this.store.createRecord(
      //   "projectApplicant",
      //   {
      //     emailaddress: this.args.package.contactEmail,
      //     firstname: "John",
      //     lastname: "Doe",
      //     project,
      //   },
      ...
      // console.debug("project applicants", projectApplicants);
      // console.debug("project applicant", projectApplicant);
      await project.save();
