...
@UseInterceptors(
  new JsonApiSerializeInterceptor('packages', {
    ...
    project: {
      ref: 'dcp_projectid',
      attributes: [...PROJECT_ATTRS, 'artifact'],
      artifact: {
        ref: 'dcp_artifactsid',
        attributes: [...ARTIFACTS_ATTRS],
      },
    },
    'ceqr-invoice-questionnaires': {
    ...
    'pas-form': {
      ...
      'project-addresses': {
        ...
        attributes: [...PAS_FORM_PROJECTADDRESS_ATTRS],
      },
      applicants: {
    ...
    'rwcds-form': {
      ref: 'dcp_rwcdsformid',
      attributes: [...RWCDS_FORM_ATTRS, 'affected-zoning-resolutions'],
    ...
    'landuse-form': {
      ...
      'related-actions': {
        ...
        attributes: [...RELATED_ACTION_ATTRS, 'dcp_applicationdate'],
      },
      'landuse-actions': {
        ...
        'zoning-resolution': {
          ...
          attributes: [...ZONINGRESOLUTION_ATTRS],
        },
      },
      'sitedatah-forms': {
        ...
        if (pasForm) {
          return {
            ...
            'pas-form': {
              ...
              applicants: [
                ...
                ...pasForm.dcp_dcp_applicantrepinformation_dcp_pasform.map(
                  (applicant) => {
                    ...
                    applicant['target_entity'] =
                      'dcp_applicantrepresentativeinformation';
          ...
          return {
            ...
            'rwcds-form': {
              ...rwcdsForm,
              'affected-zoning-resolutions':
                rwcdsForm.dcp_rwcdsform_dcp_affectedzoningresolution_rwcdsform,
            },
          };
        } else if (landuseForm) {
          return {
            ...
            'landuse-form': {
              ...
              applicants: [
                ...
                ...landuseForm.dcp_dcp_applicantrepinformation_dcp_landuse.map(
                  (applicant) => {
                    // map this array to handle the slight differences in schemas between these two entities
                    // that we treat as one applicants array on the frontend
              ...
              'landuse-actions': landuseForm.landuseActions.map((action) => {
                return {
                  ...action,
                  'zoning-resolution':
                    action.dcp_zoningresolutionsectionactionispursuantto,
                };
              }),
              'sitedatah-forms':
                landuseForm.dcp_dcp_landuse_dcp_sitedatahform_landuseform,
              'landuse-geographies':
                landuseForm.dcp_dcp_landuse_dcp_landusegeography_landuseform,
              'lead-agency': landuseForm.dcp_leadagency,
              'affected-zoning-resolutions':
                landuseForm.dcp_dcp_landuse_dcp_affectedzoningresolution_Landuseform,
              'zoning-map-changes':
                landuseForm.dcp_dcp_landuse_dcp_zoningmapchanges_LandUseForm,
            },
          };
        } else {
          return {
            ...projectPackage,
            'ceqr-invoice-questionnaires':
              projectPackage.dcp_package_dcp_ceqrinvoicequestionnaire_Package,
          };
        }
      } catch (e) {
