    ...
    try {
      ...
      return {
        ...
        documents: documents.map((document) => ({
          ...
          // When switching to the graph api, it made more sense
          // to reference files by their id. However, we keep "serverRelativeUrl"
          // naming to preserve compatibility with the frontend
        ...
        throw new HttpException(
          {
            ...
            detail: `An unknown error occurred while loading package ${packageId}`,
          },
          HttpStatus.NOT_FOUND,
        );
      }
